...
public class RegistrationActivity extends Activity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptLogin() throws IOException {
        ...
        sensors= mSensorsView.getText().toString();
...
// Install the all-trusting trust manager
                ...
                String url = "https://54.174.88.49:3000/CreateAccount";
                URL obj = new URL(url);
                trustAllHosts();
      ...
      //          con.setRequestProperty("Content-Type", "application/json");
                ...
                con.setRequestProperty("username", name);
                con.setRequestProperty("password", password);
                con.setRequestProperty("firstname", name);
                con.setRequestProperty("lastname", name);
                con.connect();
