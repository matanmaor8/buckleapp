...
public class RangedIBeacon extends BleDeviceInfo{
    ...
    public RangedIBeacon(BleDeviceInfo ibeacon) {
        super();
        //      super(ibeacon);
        addMeasurement(this.mRssi);
    }
    ...
    protected void addRangeMeasurement(Integer rssi) {
        ...
        setAvaragedRssi(runningAverageRssi);
        Log.d(TAG, "runningAverageRssi:"+runningAverageRssi);
